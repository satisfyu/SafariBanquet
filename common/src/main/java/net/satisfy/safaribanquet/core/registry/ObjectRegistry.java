...
public class ObjectRegistry {
    ...
    public static final ItemStack SEASONED_CASSOWARY_MEAT_RECIPE_BOOK_STACK = GrandmothersRecipeBookItem.createUnlockerForRecipes(SEASONED_CASSOWARY_MEAT_RECIPE_BOOK.get(), "farm_and_charm:pot_cooking/seasoned_cassowary_meat");
    ...
    public static final ItemStack PELICAN_POTROAST_RECIPE_BOOK_STACK = GrandmothersRecipeBookItem.createUnlockerForRecipes(PELICAN_POTROAST_RECIPE_BOOK.get(), "farm_and_charm:pot_cooking/pelican_potroast");
    ...
    public static final ItemStack TURKEY_ON_A_BED_OF_SHROOMS_RECIPE_BOOK_STACK = GrandmothersRecipeBookItem.createUnlockerForRecipes(TURKEY_ON_A_BED_OF_SHROOMS_RECIPE_BOOK.get(), "farm_and_charm:stove/turkey_on_a_bed_of_shrooms");
    ...
    public static final ItemStack HAZELNUT_PIE_RECIPE_BOOK_STACK = GrandmothersRecipeBookItem.createUnlockerForRecipes(HAZELNUT_PIE_RECIPE_BOOK.get(), "farm_and_charm:stove/hazelnut_pie");
    ...
    public static final ItemStack PELICAN_IN_LILIPADS_WITH_OAT_PATTIES_RECIPE_BOOK_STACK = GrandmothersRecipeBookItem.createUnlockerForRecipes(PELICAN_IN_LILIPADS_WITH_OAT_PATTIES_RECIPE_BOOK.get(), "farm_and_charm:stove/pelican_in_lilipads_with_oat_patties");
    ...
    public static final ItemStack PORKCHOP_WITH_TRUFFLES_RECIPE_BOOK_STACK = GrandmothersRecipeBookItem.createUnlockerForRecipes(PORKCHOP_WITH_TRUFFLES_RECIPE_BOOK.get(), "farm_and_charm:roaster/porkchop_with_truffles");
    ...
    public static final ItemStack VENISON_WITH_POTATOES_RECIPE_BOOK_STACK = GrandmothersRecipeBookItem.createUnlockerForRecipes(VENISON_WITH_POTATOES_RECIPE_BOOK.get(), "farm_and_charm:roaster/venison_with_potatoes");
    ...
    public static final ItemStack TURKEY_WITH_VEGETABLES_RECIPE_BOOK_STACK = GrandmothersRecipeBookItem.createUnlockerForRecipes(TURKEY_WITH_VEGETABLES_RECIPE_BOOK.get(), "farm_and_charm:roaster/turkey_with_vegetables");
